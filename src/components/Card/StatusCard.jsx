                ...
                <div className="card p-5 rounded-3xl bg-white/5" key={book.id}>
                    ...
                    <div className="card-body w-full mt-4">
                        ...
                        <div className="flex h-fit">
                            <a href="" className="flex bg-indigo-600 hover:bg-indigo-700 px-4 py-2 mt-4 rounded-md font-medium justify-center flex-1">
                                Load More
                            </a>
                            <div className="flex justify-center items-center px-4 bg-red-500 hover:bg-red-600 cursor-pointer ml-3 rounded-md py-2 self-end">
                                <i class="bi bi-arrow-down-circle-fill text-indigo-red-600"></i>
                            </div>
                        </div>
                    </div>
                </div>
